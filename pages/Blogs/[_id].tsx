...
const SingleBlogPage = ({singleBlog}: SingleBlogObj) => {
  ...
  const [avgscr, setAvgscr] = useState(singleBlog.averageScore);
  ...
  const submitRate = async () => {
    ...
    if (data.msg === "ok") {
      toast.success("Your rating added!", {theme: "dark"});
      return setAvgscr(singleBlog.averageScore);
    }
  ...
  return (
    <>
      <Head>
        <title>
          {process.env.TITLE} | {singleBlog.title}
        </title>
      ...
      <Grid
        ...
        <Grid
          ...
          <Typography variant='fadeText'>
            {avgscr.toFixed(2)} from {singleBlog.rateCount} votes
          </Typography>
          <Container
            disableGutters
            maxWidth={false}
            ...
            <Link
              href={{
                ...
                query: {_id: singleBlog?.creator?._id},
              }}>
              <Avatar
                alt='user-avatar'
